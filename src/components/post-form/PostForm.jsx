...
function PostForm({ post }) {
    ...
    return (
      ...
      {/* ✅ Full width on mobile, split 2/3 on md+ */}
      ...
      {/* ✅ Full width on mobile, split 1/3 on md+ */}
      <div className="w-full md:w-1/3 px-2">
        <Input
          label="Featured Image :"
          type="file"
          className="mb-4"
          accept="image/png, image/jpg, image/jpeg, image/gif, image/webp"  /* ✅ fixed missing comma */
